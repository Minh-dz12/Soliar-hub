...
local HomeTab = Window:MakeTab({"Thông tin", ""})
local MainTab = Window:MakeTab({"Chính", ""})
local SeaTab = Window:MakeTab({"Sự kiện", ""})
local ITMTab = Window:MakeTab({"Vật phẩm", ""})
local SettingsTab = Window:MakeTab({"Cài đặt", ""})
local StatusTab = Window:MakeTab({"Trạng thái", ""})
local StatsTab = Window:MakeTab({"Chỉ số", ""})
local PlayerTab = Window:MakeTab({"Người chơi", ""})
local TeleportTab = Window:MakeTab({"Dịch chuyển", ""})
local VisualTab = Window:MakeTab({"Giả", ""})
local FruitTab = Window:MakeTab({"Trái", ""})
local RaidTab = Window:MakeTab({"Tập kích", ""})
local RaceTab = Window:MakeTab({"Tộc", ""})
local ShopTab = Window:MakeTab({"Cửa hàng", ""})
local MiscTab = Window:MakeTab({"Khác", ""})
