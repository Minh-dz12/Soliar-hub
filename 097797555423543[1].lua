...
Window:AddMinimizeButton({
    Button = {
        Image = "rbxassetid://89060867812752",
...
local o1Tab = Window:MakeTab({"Thông tin", ""})
local o2Tab = Window:MakeTab({"Chính", ""})
local o3Tab = Window:MakeTab({"Sự kiện", ""})
local o4Tab = Window:MakeTab({"Vật phẩm", ""})
local o5Tab = Window:MakeTab({"Cài đặt", ""})
local o6Tab = Window:MakeTab({"Trạng thái", ""})
local o7Tab = Window:MakeTab({"Chỉ số", ""})
local o8Tab = Window:MakeTab({"Người chơi", ""})
local o9Tab = Window:MakeTab({"Dịch chuyển", ""})
local o10Tab = Window:MakeTab({"Giả", ""})
local o11Tab = Window:MakeTab({"Trái", ""})
local o12Tab = Window:MakeTab({"Tập kích", ""})
local o13Tab = Window:MakeTab({"Tộc", ""})
local o14Tab = Window:MakeTab({"Cửa hàng", ""})
local o15Tab = Window:MakeTab({"Khác", ""})
...
local v48 = o2Tab:AddDropdown("DropdownSelectWeapon", {
    Title = "Vũ Khí",
    Description = "",
    Values = {
        "Melee",
...
local v49 = o2Tab:AddToggle("ToggleLevel", {
    Title = "Cày Cấp",
    Description = "",
    Default = false
});
...
local v50 = o2Tab:AddToggle("ToggleMobAura", {
    Title = "Đánh Quái Gần",
    Description = "",
    Default = false
});
...
local v51 = o2Tab:AddToggle("ToggleCastleRaid", {
    Title = "Đánh Hải Tặc",
    Description = "",
    Default = false
});
...
local v52 = o2Tab:AddToggle("ToggleHakiFortress", {
...
local v55 = o2Tab:AddToggle("ToggleCollectChest", {
    Title = "Nhặt Rương",
    Description = "",
    Default = false
});
...
local v56 = o2Tab:AddSection("Thông Thạo");
local v57 = o2Tab:AddDropdown("DropdownMastery", {
...
local v58 = o2Tab:AddToggle("ToggleMasteryFruit", {
    Title = "Farm Trái",
    Description = "",
    Default = false
});
...
local v59 = o2Tab:AddSlider("SliderHealt", {
    Title = "Máu Quái",
    Description = "",
    Default = 20,
    Min = 0,
...
if Sea3 then
    local v484 = o2Tab:AddSection("Xương");
    local v485 = o2Tab:AddParagraph({
    ...
    local v486 = o2Tab:AddToggle("ToggleBone", {
        Title = "Cày Xương",
        Description = "",
        Default = false
    });
    ...
    local v489 = o2Tab:AddToggle("ToggleRandomBone", {
        Title = "Random Xương",
        Description = "",
        Default = false
    });
...
if Sea3 then
    local v490 = o2Tab:AddSection("Tư Lệnh Bánh");
    local v491 = o2Tab:AddParagraph({
        Title = "Trạng Thái Spawn",
        Content = ""
    });
    spawn(function()
        while wait() do
    ...
    local v492 = o2Tab:AddToggle("ToggleCake", {
    ...
    local v494 = o2Tab:AddToggle("ToggleDoughKing", {
        Title = "Đấm Vua Bột",
        Description = "",
        Default = false
    });
    ...
    local v495 = o2Tab:AddToggle("ToggleSpawnCake", {
...
if Sea2 then
    local v496 = o2Tab:AddSection("Ectoplasm Farm");
    local v497 = o2Tab:AddToggle("ToggleVatChatKiDi", {
...
local v60 = o2Tab:AddSection("Trùm");
if Sea1 then
    tableBoss = {
        "The Gorilla King",
        "Bobby",
...
local v61 = o2Tab:AddDropdown("DropdownBoss", {
    Title = "Chọn Trùm",
    Description = "",
    Values = tableBoss,
    Multi = false,
...
local v62 = o2Tab:AddToggle("ToggleAutoFarmBoss", {
    Title = "Đấm Trùm",
    Description = "",
    Default = false
});
...
local v63 = o2Tab:AddSection("Nguyên Liệu");
if Sea1 then
    MaterialList = {
        "Scrap Metal",
        "Leather",
...
local v64 = o2Tab:AddDropdown("DropdownMaterial", {
...
local v65 = o2Tab:AddToggle("ToggleMaterial", {
...
if Sea3 then
    local v498 = o3Tab:AddSection("Đảo Cáo");
    local v499 = o3Tab:AddParagraph({
    ...
    local v500 = o3Tab:AddToggle("ToggleEspKitsune", {
    ...
    local v501 = o3Tab:AddToggle("ToggleTPKitsune", {
    ...
    local v502 = o3Tab:AddToggle("ToggleCollectAzure", {
...
if Sea3 then
    ...
    local v508 = 350;
    local v509 = o3Tab:AddSlider("SliderSpeedBoat", {
        Title = "Tốc Độ Thuyền",
        Description = "",
        Default = v508,
        Min = 0,
    ...
    v509:SetValue(v508);
    local v510 = o3Tab:AddToggle("AutoFindPrehistoric", {
    ...
    local v514 = o3Tab:AddToggle("AutoFindMirage", {
        Title = "Tìm Đảo Bí Ẩn",
        Description = "",
        Default = false
    });
    ...
    local v515 = o3Tab:AddToggle("AutoFindFrozen", {
    ...
    local v516 = o3Tab:AddToggle("AutoComeTiki", {
    ...
    local v517 = o3Tab:AddToggle("AutoComeHydra", {
    ...
    local v519 = o3Tab:AddDropdown("DropdownBoat", {
        Title = "Chọn Thuyền",
        Description = "",
        Values = v518,
        Multi = false,
    ...
    local v522 = o3Tab:AddToggle("ToggleTerrorshark", {
        Title = "Đấm Cá Mập",
        Description = "",
        Default = false
    });
    ...
    local v523 = o3Tab:AddToggle("TogglePiranha", {
        Title = "Đấm Piranha",
        Description = "",
        Default = false
    });
    ...
    local v524 = o3Tab:AddToggle("ToggleShark", {
        Title = "Đấm Cá Con",
        Description = "",
        Default = false
    });
    ...
    local v525 = o3Tab:AddToggle("ToggleFishCrew", {
        Title = "Đấm Tàu Cá",
        Description = "",
        Default = false
    });
    ...
    local v526 = o3Tab:AddToggle("ToggleShip", {
        Title = "Đấm Tàu",
        Description = "",
        Default = false
    });
    ...
    local v527 = o3Tab:AddToggle("ToggleGhostShip", {
        Title = "Đấm Tàu Ma",
        Description = "",
        Default = false
    });
    ...
    local v528 = o2Tab:AddSection("Elite");
    local v529 = o2Tab:AddParagraph({
    ...
    local v530 = o2Tab:AddToggle("ToggleElite", {
        Title = "Đấm Elite",
        Description = "",
        Default = false
    });
...
if Sea3 then
    local v531 = o3Tab:AddSection("Đảo Bí Ẩn");
    local v532 = o3Tab:AddParagraph({
        Title = "Trạng Thái",
        Content = ""
    });
    task.spawn(function()
...
local v66 = o3Tab:AddToggle("ToggleTpAdvanced", {
...
local v67 = o3Tab:AddToggle("ToggleTweenGear", {
...
local v68 = o3Tab:AddToggle("Togglelockmoon", {
...
local v69 = o4Tab:AddToggle("ToggleAutoSaber", {
    Title = "Saber",
    Description = "",
    Default = false
});
...
local v70 = o4Tab:AddToggle("ToggleAutoPoleV1", {
    Title = "Pole V1",
    Description = "",
    Default = false
});
...
local v72 = o4Tab:AddToggle("ToggleAutoSaw", {
    Title = "Cưa Cá Mập",
    Description = "",
    Default = false
});
...
local v73 = o4Tab:AddToggle("ToggleAutoWarden", {
...
if Sea3 then
    local v533 = o4Tab:AddToggle("ToggleHallow", {
        Title = "Lưỡi Hái",
        Description = "",
        Default = false
    });
    ...
    local v534 = o4Tab:AddToggle("ToggleYama", {
        Title = "Yama",
        Description = "",
        Default = false
    });
    ...
    local v535 = o4Tab:AddToggle("ToggleTushita", {
        Title = "Tushita",
        Description = "",
        Default = false
    });
    ...
    local v536 = o4Tab:AddToggle("ToggleHoly", {
        Title = "Đốt Đuốc",
        Description = "",
        Default = false
    });
...
local v75 = o4Tab:AddToggle("ToggleAutoCanvander", {
    Title = "Canvander",
    Description = "",
    Default = false
});
...
local v76 = o4Tab:AddToggle("ToggleAutoMusketeerHat", {
...
local v77 = o4Tab:AddToggle("ToggleAutoObservationV2", {
...
local v78 = o4Tab:AddToggle("ToggleAutoRainbowHaki", {
    Title = "Haki 7 Màu",
    Description = "",
    Default = false
});
...
local v79 = o4Tab:AddToggle("ToggleAutoSkullGuitar", {
    Title = "Skull Guitar",
    Description = "",
    Default = false
});
...
local v80 = o4Tab:AddToggle("ToggleAutoBuddy", {
    Title = "Kiếm Buddy",
    Description = "",
    Default = false
});
...
local v82 = o4Tab:AddToggle("ToggleAutoDualKatana", {
    Title = "Song Kiếm",
    Description = "",
    Default = false
});
...
if Sea2 then
    local v537 = o4Tab:AddToggle("ToggleFactory", {
        Title = "Đấm Nhà Máy",
        Description = "",
        Default = false
    });
...
local v83 = o4Tab:AddToggle("ToggleAutoFarmSwan", {
    Title = "Đấm Swan",
    Description = "",
    Default = false
});
...
local v84 = o4Tab:AddToggle("ToggleAutoRengoku", {
    Title = "Rengoku",
    Description = "",
    Default = false
});
...
if (Sea2 or Sea3) then
    local v538 = o4Tab:AddToggle("ToggleHakiColor", {
        Title = "Mua Màu Haki",
        Description = "",
        Default = false
    });
...
if Sea2 then
    local v539 = o4Tab:AddToggle("ToggleSwordLengend", {
...
if Sea2 then
    local v540 = o13Tab:AddToggle("ToggleEvoRace", {
        Title = "Nâng Tộc V2",
        Description = "",
        Default = false
    });
...
local v85 = o5Tab:AddToggle("ToggleAutoT", {
    Title = "Bật Tộc V3",
    Description = "",
    Default = false
});
...
local v86 = o5Tab:AddToggle("ToggleAutoY", {
    Title = "Bật Tộc V4",
    Description = "",
    Default = false
});
...
local v87 = o5Tab:AddToggle("ToggleAutoKen", {
...
local v88 = o5Tab:AddToggle("ToggleSaveSpawn", {
...
v89:Stop();
local v90 = o5Tab:AddToggle("ToggleBringMob", {
    Title = "Gom Quái",
    Description = "",
    Default = true
});
...
local v91 = o5Tab:AddToggle("ToggleRemoveNotify", {
    Title = "Xóa Thông Báo",
    Description = "",
    Default = false
});
...
local v92 = o5Tab:AddToggle("ToggleWhite", {
...
local v93 = o5Tab:AddSection("Kĩ Năng Thông Thạo");
local v94 = o5Tab:AddToggle("ToggleZ", {
    Title = "Kĩ Năng Z",
    Description = "",
    Default = true
});
...
local v95 = o5Tab:AddToggle("ToggleX", {
    Title = "Kĩ Năng X",
    Description = "",
    Default = true
});
...
local v96 = o5Tab:AddToggle("ToggleC", {
    Title = "Kĩ Năng C",
    Description = "",
    Default = true
});
...
local v97 = o5Tab:AddToggle("ToggleV", {
    Title = "Kĩ Năng V",
    Description = "",
    Default = true
});
...
local v98 = o5Tab:AddToggle("ToggleF", {
    Title = "Kĩ Năng F",
    Description = "",
    Default = false
});
...
local v105 = o6Tab:AddInput("Input", {
    Title = "Job ID",
    Default = "",
...
local v107 = o7Tab:AddToggle("ToggleMelee", {
    Title = "Nâng Đấm",
    Description = "",
    Default = false
});
...
local v108 = o7Tab:AddToggle("ToggleDe", {
    Title = "Nâng Máu",
    Description = "",
    Default = false
});
...
local v109 = o7Tab:AddToggle("ToggleSword", {
    Title = "Nâng Kiếm",
    Description = "",
    Default = false
});
...
local v110 = o7Tab:AddToggle("ToggleGun", {
    Title = "Nâng Súng",
    Description = "",
    Default = false
});
...
local v111 = o7Tab:AddToggle("ToggleFruit", {
    Title = "Nâng Trái",
    Description = "",
    Default = false
});
...
local v113 = o8Tab:AddDropdown("SelectedPly", {
...
local v114 = o8Tab:AddToggle("ToggleTeleport", {
...
local v56 = o8Tab:AddSection("Khác");
local v115 = o8Tab:AddToggle("ToggleNoClip", {
...
local v116 = o8Tab:AddToggle("ToggleWalkonWater", {
    Title = "Đi Trên Nước",
    Description = "",
    Default = true
});
...
local v117 = o8Tab:AddToggle("ToggleEnablePvp", {
    Title = "Bật PVP",
    Description = "",
    Default = false
});
...
local v118 = o9Tab:AddSection("Thế Giới");
local v119 = o9Tab:AddToggle("ToggleAutoSea2", {
...
local v120 = o9Tab:AddToggle("ToggleAutoSea3", {
...
local v56 = o9Tab:AddSection("Đảo");
if Sea1 then
    IslandList = {
        "WindMill",
        "Marine",
...
local v121 = o9Tab:AddDropdown("DropdownIsland", {
    Title = "Chọn Đảo",
    Description = "",
    Values = IslandList,
    Multi = false,
...
o10Tab:AddInput("Input_Fragments", {
    Title = "Điểm F",
    Default = "",
    Placeholder = "Nhập",
    Numeric = false,
...
local v111 = o11Tab:AddToggle("ToggleFruit", {
    Title = "Mua Trái Chọn",
    Description = "",
    Default = false
});
...
v17.ToggleFruit:SetValue(false);
local v124 = o11Tab:AddDropdown("DropdownPermanentFruit", {
...
local v125 = o11Tab:AddToggle("TogglePermanentFruit", {
...
local v126 = o11Tab:AddToggle("ToggleStore", {
    Title = "Lưu Trái",
    Description = "",
    Default = false
});
...
local v127 = o11Tab:AddToggle("ToggleRandomFruit", {
    Title = "Random Trái",
    Description = "",
    Default = false
});
...
local v128 = o11Tab:AddToggle("ToggleCollectTP", {
    Title = "Bay Đến Trái",
    Description = "",
    Default = false
});
...
local v129 = o11Tab:AddToggle("ToggleCollect", {
...
local v56 = o11Tab:AddSection("Định Vị");
local v130 = o11Tab:AddToggle("ToggleEspPlayer", {
    Title = "Người Chơi",
    Description = "",
    Default = false
});
...
local v131 = o11Tab:AddToggle("ToggleEspFruit", {
    Title = "Trái",
    Description = "",
    Default = false
});
...
local v132 = o11Tab:AddToggle("ToggleEspIsland", {
    Title = "Đảo",
    Description = "",
    Default = false
});
...
local v133 = o11Tab:AddToggle("ToggleEspFlower", {
    Title = "Hoa",
    Description = "",
    Default = false
});
...
local v134 = o11Tab:AddToggle("ToggleEspRealFruit", {
...
local v135 = o11Tab:AddToggle("ToggleIslandMirageEsp", {
    Title = "Đảo Bí Ẩn",
    Description = "",
    Default = false
});
...
local v137 = o12Tab:AddDropdown("DropdownRaid", {
    Title = "Chọn Chip",
    Description = "",
    Values = v136,
    Multi = false,
...
local v138 = o12Tab:AddToggle("ToggleBuy", {
    Title = "Mua Chip",
    Description = "",
    Default = false
});
...
local v139 = o12Tab:AddToggle("ToggleStart", {
    Title = "Bắt Đầu Raid",
    Description = "",
    Default = false
});
...
local v140 = o12Tab:AddToggle("ToggleNextIsland", {
...
local v141 = o12Tab:AddToggle("ToggleAwake", {
    Title = "Thức Tỉnh",
    Description = "",
    Default = false
});
...
local v142 = o12Tab:AddToggle("ToggleGetFruit", {
...
local v56 = o12Tab:AddSection("Tập Kích Law");
local v143 = o12Tab:AddToggle("ToggleLaw", {
...
local v56 = o13Tab:AddSection("Tộc");
o13Tab:AddButton({
    Title = "Cửa Tộc",
    Description = "",
    Callback = function()
...
local v144 = o13Tab:AddToggle("ToggleHumanandghoul", {
...
local v145 = o13Tab:AddToggle("ToggleAutotrial", {
    Title = "Hoàn Thành Ải",
    Description = "",
    Default = false
});
...
local v146 = o13Tab:AddToggle("ToggleKillTrial", {
...
local v56 = o13Tab:AddSection("Huấn Luyện");
local v147 = o13Tab:AddToggle("ToggleFarmRace", {
    Title = "Cày Luyện Tộc",
    Description = "",
    Default = false
});
...
local v149 = o13Tab:AddToggle("ToggleUpgrade", {
    Title = "Mua Gear",
    Description = "",
    Default = false
});
...
local v56 = o14Tab:AddSection("Khả Năng");
v16.Shop:AddButton({
    Title = "Nhảy",
    Description = "",
    Callback = function()
...
local v56 = o14Tab:AddSection("Kiếm");
v16.Shop:AddButton({
    Title = "Cutlass",
    Description = "",
    Callback = function()
...
local v56 = o14Tab:AddSection("Võ");
o14Tab:AddButton({
    Title = "Black Leg",
    Description = "",
    Callback = function()
...
local v56 = o14Tab:AddSection("Khác");
o14Tab:AddButton({
    Title = "Đổi Chỉ Số",
    Description = "",
    Callback = function()
...
local v56 = o15Tab:AddSection("Đội");
o15Tab:AddButton({
    Title = "Join Hải Tặc",
    Description = "",
    Callback = function()
...
local v56 = o15Tab:AddSection("Kinh Nghiệm");
local v150 = {
    "KITT_RESET",
    "Sub2UncleKizaru",
...
local v56 = o15Tab:AddSection("Khác");
local v151 = o15Tab:AddToggle("ToggleRejoin", {
    Title = "Join Lại Sever",
    Description = "",
    Default = true
});
...
local v56 = o15Tab:AddSection("Sương");
local function v152()
...
local v153 = o15Tab:AddToggle("ToggleAntiBand", {
    Title = "Chống Band",
    Description = "",
    Default = true
});
...
local v56 = o3Tab:AddSection("Leviathan");
o3Tab:AddButton({
...
local v155 = o3Tab:AddToggle("ToggleTPFrozenDimension", {
...
local v156 = o3Tab:AddSection("Draco");
local v157 = o3Tab:AddToggle("ToggleBlazeEmber", {
    Title = "Nhặt Lửa Đỏ",
    Description = "",
    Default = false
});
...
local v158 = o3Tab:AddToggle("ToggleReceiveQuest", {
...
local v160 = o3Tab:AddToggle("ToggleHydraTree", {
...
local v164 = o3Tab:AddToggle("ToggleCollectFireFlowers", {
    Title = "Nhặt Hoa Đỏ",
    Description = "",
    Default = false
});
...
local v165 = o3Tab:AddToggle("ToggleWhiteBelt", {
    Title = "Farm Đai Trắng",
    Description = "",
    Default = false
});
...
local v166 = o3Tab:AddParagraph({
    Title = "Hoàn Thành Ải Draco V4",
    Content = "ko bt lm:)"
});
local v167 = o3Tab:AddToggle("ToggleTrialTeleport", {
...
local v168 = o3Tab:AddSection("Đảo Dung Nham");
local v169 = o3Tab:AddParagraph({
...
local v170 = o3Tab:AddToggle("ToggleTPVolcano", {
...
local v171 = o3Tab:AddToggle("ToggleDefendVolcano", {
    Title = "Phòng Thủ",
    Description = "",
    Default = false
});
...
local v107 = o3Tab:AddToggle("ToggleMelee", {
    Title = "Dùng Melee",
    Description = "",
    Default = false
});
...
local v109 = o3Tab:AddToggle("ToggleSword", {
    Title = "Dùng Sword",
    Description = "",
    Default = false
});
...
local v110 = o3Tab:AddToggle("ToggleGun", {
    Title = "Dùng Gun",
    Description = "",
    Default = false
});
...
local v175 = o3Tab:AddToggle("ToggleKillAura", {
...
local v176 = o3Tab:AddToggle("ToggleCollectBone", {
    Title = "Nhặt Xương",
    Description = "",
    Default = false
});
...
local v177 = o3Tab:AddToggle("ToggleCollectEgg", {
    Title = "Nhặt Trứng",
    Description = "",
    Default = false
});
